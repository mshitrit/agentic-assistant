...
- **Scope:** **Namespaced** (CRs and referenced **Secrets** use the **same namespace** as the FAR/Template CR) — covered in **`architecture.md`**, **`overview.md`**, **`runbook.md`**.
