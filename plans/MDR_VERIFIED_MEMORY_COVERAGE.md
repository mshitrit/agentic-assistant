...
**`code_map.md`:** **`main.go`**, **`api/v1alpha1/*`**, **`controllers/machinedeletionremediation_controller.go`**, **`version/version.go`** — no separate **`pkg/`** app package beyond vendor. — **✓** in **`memory/verified/mdr/code_map.md`**.
