...
| **`SelfNodeRemediationConfig`** | Cluster-scoped config (name **`self-node-remediation-config`**) — timings, watchdog path, peer thresholds, DaemonSet tolerations, etc. Without it, SNR is **Disabled** for new remediations. |
